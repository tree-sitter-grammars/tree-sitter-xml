...
enum {
  ...
  sym_CData = 66,
  anon_sym_xml_DASHstylesheet = 67,
  anon_sym_xml_DASHmodel = 68,
  sym_PITarget = 69,
  sym__pi_content = 70,
  sym_Comment = 71,
  sym_CharData = 72,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 132:
      ...
      if (aux_sym_PubidLiteral_token1_character_set_1(lookahead)) ADVANCE(132);
      END_STATE();
    case 133:
      ACCEPT_TOKEN(aux_sym_PubidLiteral_token2);
      if (aux_sym_PubidLiteral_token2_character_set_1(lookahead)) ADVANCE(133);
      END_STATE();
    case 134:
